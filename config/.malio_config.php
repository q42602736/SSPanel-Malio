...
// 支付宝目前支持 bitpayx | tomatopay | f2fpay | st
$Malio_Config['mups_alipay'] = 'wolfpay';   // Malio 聚合支付系统里面的 支付宝 要用的支付平台  
// 微信支付目前支持 bitpayx | stripe
$Malio_Config['mups_wechat'] = 'stripe';   // Malio 聚合支付系统里面的 微信支付 要用的支付平台
...
####### 订阅设置 #######
// {{ AURA-X: Add - 添加VLESS和HY2协议支持. Source: malio项目移植 }}
$Malio_Config['support_sub_type'] = ['ss','ssr','v2ray','vless','hysteria2'];    // 选择网站支持的代理协议，会影响复制订阅链接和一键导入按钮的显示。比如删除这个参数里的ss，则 Surge 订阅按钮不会显示再首页上，教程里也不会显示Surge教程
...
$Malio_Config['daily_bonus_settings'] = array(  // 分等级给签到流量
    1 => array(  // 用户等级
        'min' => 100,  // 最低流量，单位为MB
        'max' => 200   // 最高流量，单位为MB
    ),
